...
import {AndroidSafeArea, categories, COLORS, dummyData, FONTS,} from '../../constants';
import {ElementSvg, FilterSvg, FreeDeliverySvg, MicrophoneSvg, ProfileArrowSvg, SmallMapPin, StarSvg,} from '../../svg';
        ...
        return (
            <View>
                <View
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Filter' as never)}>
                        <FilterSvg/>
                    </TouchableOpacity>
                </View>
