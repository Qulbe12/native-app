...
import {Button, CheckoutCategory, Header} from "../../components";
import {AndroidSafeArea, COLORS, FONTS, SIZES} from "../../constants";
import {ApplePaySvg, ClipboardSvg, CreditCardTwoSvg, CrossSvg, MapPinSvg, PayPalSvg, SmallMapPinTwo,} from "../../svg";
        ...
        return (
            ...
            >
                ...
                <Button
                    ...
                    onPress={() => navigation.navigate("CheckoutSuccess" as never)}
                />
            </ScrollView>
        );
    }
                    ...
                    {addresses.map((item, index) => {
                        return (
                            <TouchableOpacity
                                ...
                                onPress={() => setSelectAddress(item.id as never)}
                            >
                                <View>
                                    <Text
                                        style={{
